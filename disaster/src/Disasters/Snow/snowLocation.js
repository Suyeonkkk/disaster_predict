...
class SnowLocation extends Component {
// 서울 108 인천 112 대구 143 대전 133 부산 159 울산 152 광주 156 제주도 184
    ...
    call = async() => {
        return fetch('http://127.0.0.1:5000/SnowLocation', {
            method: 'get',
            headers: {
                ...
                <div className="maindisplay">
                    ...
                    <div className="infowhitebox oneline">
                        <div className="explain">
                            <p className="infomainfont">다른 지역에서 눈이 내릴 확률입니다.
                            <br></br>
                            <br></br>
                            <br></br></p>
